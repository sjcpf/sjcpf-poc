...
import { appName, seasons } from '@/shared/constants'
import { RouteNameEnum } from '@/shared/enums'
import { backIcon, searchIcon } from '@/shared/icons'
import { useMeta } from 'quasar'
import { ref } from 'vue'

useMeta({ title: `${appName} - Seasons` })
...
<template>
  <PageResponsive>
    <div class="hero-top-bar flex justify-left items-center">
      ...
      <h4 class="text-h6 hero-top-bar page-name">Seasonal Activities</h4>
    </div>
    <q-input
      class="pill-search"
      rounded filled
    ...
    <div class="q-pa-md">
      ...
      >
        <div class="absolute-bottom text-white text-subtitle2 q-pa-sm">
          <p class="image-button-label">{{season.name}}</p>
        </div>
      </q-img>
    </div>
  </PageResponsive>
